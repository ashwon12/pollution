...
public class Talk extends JPanel {
	...
	private String[] talk = { "자연과 가까울수록 병은 멀어지고, 자연과 멀수록 병은 가까워진다.  <br>-괴테-",
			...
			"자연계에서 등을 돌리는 것은 결국 우리 행복에서 등을 돌리는 것과 같다. <br>-사무엘 존슨-", "자연에는 비약이 없다. <br>-다윈-",
			"자연에는 완벽한 신의 형상이라고 느끼게 하는 것이 있는가 하면,<br>전혀 그렇지 않다고 느끼게 하는 불완전한 것도 있다. <br>-파스칼-", "자연에 따라 살아야 한다. <br>-제논-",
			"자연계에서 멀어져 가는 일없이 자연이 우리에게 보여주는 법칙과 본보기에 따라 <br>우리의 행동 방침을 정해 나간다면 우리는 참된 지혜를 터득할 수 있을 것이다. <br>-세네카-",
			"자연에는 보수도 형벌도 없고 결과가 있을 뿐이다. <br>- 로버트 그린 잉거솔-", "자연은 결코 우리를 속이지 않는다. 우리를 속이는 것은 언제나 우리 자신이다. <br>-루소-",
			"자연은 사원이 아니고 한갓 커다란 공장이다. 그리고 인간은 거기서 일하는 노동자이다. <br>-투르게네프-",
			"자연의 도는 말로써 표현할 수 없고 자연의 덕은 인위적인 노력으로 이룰 수 없다. <br>-장자-", "자연은 신의 묵시이며, 예술은 인간의 묵시이다. <br>-H.W. 롱펠로우-",
			"자연의 자태만 보아도 그것은 하나의 즐거움이다. <br>-R.W. 에머슨-", "자연은 신의 예술품이다. <br>-단테-",
